...
<div class="container">
  <div class="panel">
    <div class="panel-body wizard-content">
      <form id="example-form" action= "{{url('updateStudent/'.$student->editid)}}" method="POST" class="tab-wizard wizard-circle wizard clearfix">
        @csrf
        @method('PUT')
        <input type="hidden" name="editid" value="{{ $student->editid }}">
      ...
      <div class="step1">
                  <div class="form-row">
                    <div class="form-group-row" style="width:90%;">
                      ...
                      <input type="text" class="form-control" id="names" name="name" value="{{$student->name}}">
                     
                    </div>
                    
                      <div class="form-group col-md-5">
                        <label for="inputbd4">Date of Birth : </label>
                        <input type="date" class="form-control" id="dob" name="date_of_birth" value="{{$student->date_of_birth}}">
                      ...
                      <input type="text" class="form-control" id="fname" name="fathers_name" value="{{$student->fathers_name}}">
                  
                    </div>
                      <div class="form-group col-md-5">
                        <label for="inputocc4">Father's Occupation : </label>
                        <input type="text" class="form-control" id="inputocc4" name="fathers_occupation" value="{{$student->fathers_occupation}}">
                      </div>
                      </div>
                    ...
                    <div class="form-group col-md-5">
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="radio" value="Male" name="gender" value="{{$student->gender}}">
                        <label class="form-check-label" for="inlineRadio1">male</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio"  id="radio" value="Female" name="gender" value="{{$student->gender}}">
                  ...
                  <input type="tel" class="form-control" id="phone" name="mobile"style="width:437px"; value="{{$student->mobile}}">
                    ...
                    <div class="form-row">
                       ...
                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="address" value="{{$student->address}}"></textarea>
                         </div>
                       ...
                       <div class="form-row">
                        ...
                        <div class="form-group col-md-5">
                          ...
                          <select class="form-control" id="district" name="district" value="{{$student->district}}">
                            <option>Select</option>
                          
                              @foreach ($districts as $district)
                            <option value="{{ $district->id }}" {{ $selectedDistrict->id == $district->id ? 'selected' : '' }}>{{ $district->name }}</option>
                        @endforeach
                          ...
                          <div class="form-group col-md-5">
                            ...
                            <select class="form-control" id="thana" name="thana" value="{{$student->thana}}">
                              <option> Select district first</option>
                              {{-- @foreach ($selectedDistrict->thanas as $thana)
                              <option value="{{ $thana->id }}" {{ $selectedThana->id == $thana->id ? 'selected' : '' }}>
                                  {{ $thana->name }}
                              </option>
                              @endforeach --}}
                        ...
                        <label for="exampleFormControlFile1" >Profile picture :</label>
                         ...
                         @if($student->profile_pic !='' && file_exists(public_path('images/' . $student->profile_pic)))
                         <img src="{{ asset('images/'.$student->profile_pic) }}" id="previewImg" style="height:150px; width:150px;" > 
                     @endif
      ...
      <script>
        ...
        var id = $(this).val();
         ...
         $.ajax({
          type: 'POST',
          url: '/Thana',
          data: 'district_id='+id+ '&_token={{csrf_token()}}',
